...
function renderPipelinePanel() {
  ...
  panel.innerHTML = ''
    ...
    + '<div class="pipe-auto-tag ck">CK: 33-tcot_pt2026-applied</div>'
    + '</div>'
    + '</div>'
    ...
    + '<div class="pipe-auto-tag ck">CK: 33-tcot_pt2026-call_scheduled</div>'
    + '</div>'
    + '<div class="pipe-card">'
    ...
    + '<div class="pipe-auto-tag ck">CK: 33-tcot_pt2026-active</div>'
    + '</div>'
    + '<div class="pipe-card">'
